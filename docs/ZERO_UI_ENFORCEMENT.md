...
- **Character Creation/Import**: IMPLEMENTED_BUT_UNSUPPORTED_NO_UI_FALLBACK. The internal wrapper exists but is disabled due to Node.js streaming hangs. UI fallback remains strictly forbidden.
